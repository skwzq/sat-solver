...
Ohjelma koostuu kolmesta moduulista: *solver.py*, *parse_files.py* ja *main.py*. *solver.py* sisältää pelkästään luokan Solver, joka sisältää ohjelman päätoiminnallisuuden. *parse_files.py* sisältää tiedostojen käsittelyyn liittyvät funktiot. *main.py* on ohjelman päämoduuli, joka käyttää Solver-luokkaa ja *parse_files.py*:n parse_cnf-funktiota.
